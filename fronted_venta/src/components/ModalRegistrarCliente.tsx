...
export function ModalRegistrarCliente({ isOpen, onClose, onClienteRegistrado }: ModalRegistrarClienteProps) {
    ...
    return (
        ...
        >
            <div
                className="bg-white rounded-lg shadow-2xl w-full max-w-md mx-4 max-h-[90vh] overflow-y-auto"
